                        ...
                        <form:form id="inputForm" cssClass="form-horizontal" action="/cargo/save" method="post" modelAttribute="tbCargo">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:select cssClass="form-control required" path="parentId">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input path="inventory" cssClass="form-control required" placeholder="请输入货物总量"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">是否为父类目</label>

                                    <div class="col-sm-10">
                                        <form:radiobutton path="parent" cssClass="required" value="1" label="是"/> &nbsp;&nbsp;&nbsp;&nbsp;
                                        <form:radiobutton path="parent" cssClass="required" value="0" label="否"/>
                                    </div>
                                </div>
                            </div>
