...
<html>
<head>
    <title>兴仁农贸市场果菜仓库信息管理系统 | 出库</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form:form id="inputForm" cssClass="form-horizontal" action="/cargo/record/user_deliverySave" method="post" modelAttribute="tbCargoRecord">
                            <form:hidden path="id"/>
                            <div class="box-body">
